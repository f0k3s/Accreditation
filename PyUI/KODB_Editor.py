...
# Form implementation generated from reading ui file 'C:\Users\f0kes\Desktop\BOT\KODB_Editor.ui'
#
...
class Ui_KO_Editor(object):
    def setupUi(self, KO_Editor):
        ...
        item = QtWidgets.QTableWidgetItem()
        self.tb_KO.setHorizontalHeaderItem(7, item)
        ...
        self.list_UPDisc = QtWidgets.QListView(self.verticalGroupBox)
        self.list_UPDisc.setObjectName("list_UPDisc")
        self.gridLayout_7.addWidget(self.list_UPDisc, 6, 0, 1, 1)
        ...
        self.list_choosenDisc = QtWidgets.QListView(self.verticalGroupBox)
        self.list_choosenDisc.setObjectName("list_choosenDisc")
        self.gridLayout_7.addWidget(self.list_choosenDisc, 6, 1, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.horizontalGroupBox, 4, 0, 1, 2)
        ...
        self.gridLayout_7.addWidget(self.gridFrame_2, 12, 0, 1, 2)
    ...
    def retranslateUi(self, KO_Editor):
        ...
        item.setText(_translate("KO_Editor", "Должн."))
        ...
        item.setText(_translate("KO_Editor", "Дисциплины"))
