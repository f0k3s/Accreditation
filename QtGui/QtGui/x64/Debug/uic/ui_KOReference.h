...
public:
    ...
    void setupUi(QDialog *KOReference)
    {
        ...
        pb_ExitKO = new QPushButton(KOReference);
        pb_ExitKO->setObjectName(QString::fromUtf8("pb_ExitKO"));
        pb_ExitKO->setFont(font);

        gridLayout->addWidget(pb_ExitKO, 0, 2, 1, 1);
    ...
    void retranslateUi(QDialog *KOReference)
    {
        ...
        pb_ExitKO->setText(QCoreApplication::translate("KOReference", "\320\227\320\260\320\272\321\200\321\213\321\202\321\214", nullptr));
    } // retranslateUi
