...
public:
    ...
    void setupUi(QDialog *StaffEdit)
    {
        ...
        pb_SaveStaff = new QPushButton(StaffEdit);
        pb_SaveStaff->setObjectName(QString::fromUtf8("pb_SaveStaff"));
        pb_SaveStaff->setFont(font);
        pb_SaveStaff->setAutoRepeatDelay(300);
        pb_SaveStaff->setAutoRepeatInterval(100);

        gridLayout->addWidget(pb_SaveStaff, 4, 3, 1, 1);
        ...
        QWidget::setTabOrder(comboBox_6, pb_SaveStaff);
    ...
    void retranslateUi(QDialog *StaffEdit)
    {
        ...
        pb_SaveStaff->setText(QCoreApplication::translate("StaffEdit", "\320\241\320\276\321\205\321\200\320\260\320\275\320\270\321\202\321\214", nullptr));
    } // retranslateUi
