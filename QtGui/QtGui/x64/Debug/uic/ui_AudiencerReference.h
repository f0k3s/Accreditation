...
public:
    ...
    void setupUi(QDialog *AudiencerReference)
    {
        ...
        pb_ExitAudience = new QPushButton(AudiencerReference);
        pb_ExitAudience->setObjectName(QString::fromUtf8("pb_ExitAudience"));
        pb_ExitAudience->setFont(font);

        gridLayout->addWidget(pb_ExitAudience, 0, 2, 1, 1);
        ...
        QWidget::setTabOrder(pushButton_2, pb_ExitAudience);
    ...
    void retranslateUi(QDialog *AudiencerReference)
    {
        ...
        pb_ExitAudience->setText(QCoreApplication::translate("AudiencerReference", "\320\227\320\260\320\272\321\200\321\213\321\202\321\214", nullptr));
